...
//  Ising_mod2
//
//  Created by Pablo BalRes on 24/01/2020.
...
/* ZHEEV prototype */
extern void zheev( char* jobz, char* uplo, int* n, dcomplex* a, int* lda, double* w, dcomplex* work, int* lwork, double* rwork, int* info );
...
int main() {
    ...
    lwork =-1;
    zheev( "Vectors", "Upper", &n, a, &lda, w, &wkopt, &lwork, rwork, &info );
    lwork = (int)wkopt.re;
    work = (dcomplex*)malloc( lwork*sizeof(dcomplex) );
    /* Solve eigenproblem */
    zheev( "Vectors", "Upper", &n, a, &lda, w, work, &lwork, rwork, &info );
